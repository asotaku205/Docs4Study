...
const getOrderById = async (req) => {
  ...
  if (!order) throw createServiceError("Order not found", 404, { message: "Order not found" });
  return order;
};
...
const deleteOrder = async (req) => {
  ...
  if (!deletedOrder) throw createServiceError("Order not found", 404, { message: "Order not found" });
...
const restoreOrder = async (req) => {
  ...
  if (!restoredOrder) throw createServiceError("Order not found", 404, { message: "Order not found" });
